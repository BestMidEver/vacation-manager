...
<ul class="nav nav-tabs mt-4">
	<li class="nav-item">
		<a class="nav-link" href="/new-leave">For myself</a>
	</li>
	<li class="nav-item">
		<a class="nav-link active">For someone else</a>
	</li>
</ul>
@endif

<form class="was-validated jumbotron mt-4" method="POST" action="/manipulate-request/new-custom">
	{{ csrf_field() }}
